---
title: High-dimensional linear state space models for dynamic microbial interaction
  networks.
author: Debosmita Kundu
date: '2019-10-09'
slug: high-dimensional-linear-state-space-models-for-dynamic-microbial-interaction-networks
---

**Speaker: Debosmita Kundu**

This week Debosmita Kundu will talk about a [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5687744/). Here is the [slides](/slides/slides_kundu.pdf). Brief summary is below:
